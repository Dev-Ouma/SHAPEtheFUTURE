      ...
      <section className="bg-primary-darker pt-48 pb-64 px-6 relative overflow-hidden flex-grow flex items-center justify-center">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center space-y-12">
           ...
           <h1 className="text-5xl md:text-6xl font-black text-white leading-none tracking-tighter uppercase font-serif">
              Path Not <span className="text-secondary">Found</span>.
           </h1>

           <p className="text-lg text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              The academic resource you are seeking has been moved, archived, or is currently being restructured for digital excellence.
           </p>
         ...
         <div className="container mx-auto max-w-7xl px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
               <div className="space-y-4">
                  ...
                  <h3 className="font-black uppercase tracking-tight text-primary-darker">Programmes</h3>
                  <p className="text-sm text-slate-500">Discover our range of digital-first undergraduate and postgraduate paths.</p>
               </div>
               <div className="space-y-4">
                  ...
                  <p className="text-xs text-slate-400 font-black uppercase tracking-widest">Open University of Kenya</p>
               </div>
               <div className="space-y-4">
                  <ArrowLeft className="mx-auto text-primary" size={32} />
                  <h3 className="font-black uppercase tracking-tight text-primary-darker">Support Hub</h3>
                  <p className="text-sm text-slate-500">Need immediate assistance? Our digital helpdesk is available 24/7.</p>
               </div>
            </div>
         </div>
      </section>
