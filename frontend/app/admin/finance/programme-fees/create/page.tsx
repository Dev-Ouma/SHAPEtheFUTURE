...
export default function CreateProgrammeFee() {
  ...
  useEffect(() => {
    async function loadFormOptions() {
      try {
        const [progsRes, yearsRes] = await Promise.all([
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto pb-24">
      ...
      <div>
        <h1 className="text-3xl font-black text-primary-darker uppercase tracking-tighter">New Fee Structure</h1>
        <p className="text-slate-500 font-medium mt-1 mb-8">Configure a new programme fee structure.</p>
      </div>
