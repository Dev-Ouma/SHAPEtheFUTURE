...
export default function CategoryManager() {
  ...
  const fetchCategories = async () => {
    setLoading(true);
    try {
      const data = await getApi('/api/campus-feedback/categories');
  ...
  return (
    <div className="space-y-8 pb-24">
      <LegacyAdminFallbackBanner message="Legacy category manager for campus feedback. ICT categories are managed under the ICT Service Desk." />
      {/* Header */}
