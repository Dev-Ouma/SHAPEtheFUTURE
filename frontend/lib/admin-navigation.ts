...
const ADMIN_SIDEBAR_SECTIONS: AdminSidebarSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Press & Media', href: '/admin/shape-press', icon: 'Newspaper', order: 5 },
      { label: 'KPIs', href: '/admin/shape-kpis', icon: 'BarChart3', order: 6 },
      { label: 'Activities', href: '/admin/shape-activities', icon: 'Clock', order: 7 },
      { label: 'Risks', href: '/admin/shape-risks', icon: 'ShieldCheck', order: 8 },
      { label: 'SDLC Stages', href: '/admin/shape-sdlc', icon: 'Layers', order: 9 },
      { label: 'Contact Inbox', href: '/admin/shape-contact', icon: 'Mail', order: 10 },
